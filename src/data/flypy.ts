...
export const commonPhrases: string[] = [
  '春风化雨', '高山流水', '风和日丽', '心平气和', '一见如故',
  '学以致用', '融会贯通', '举一反三', '循序渐进', '专心致志',
  '锦上添花', '水到渠成', '轻舟已过', '山高路远', '岁月静好',
  '坚持练习', '保持节奏', '稳定输出', '准确优先', '速度提升',
  '打字如飞', '手眼协调', '键随心动', '熟能生巧', '厚积薄发',
  '今日目标', '连续打卡', '复盘总结', '错字回练', '专项突破',
  '清风徐来', '云淡风轻', '月明星稀', '江山如画', '春华秋实',
  '不负韶华', '脚踏实地', '行稳致远', '持之以恒', '心无旁骛',
  '大道至简', '知行合一', '温故知新', '博学笃行', '精益求精',
  '今天状态不错', '先准后快更稳', '一步一个脚印', '慢慢来比较快', '专注当下输入',
  '把节奏稳定住', '按键要有力度', '眼到手到心到', '打字也要呼吸', '错误就是反馈',
  '错了马上纠正', '盯住当前字符', '速度可以再提', '准确率要守住', '连击继续保持',
  '短句训练更实战', '词组输入更自然', '从容应对长文本', '每天进步一点点', '状态越练越顺',
];
