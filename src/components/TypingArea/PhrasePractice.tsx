...
export function PhrasePractice() {
  ...
  return (
    <div className="flex flex-1 flex-col gap-5 w-full max-w-4xl mx-auto py-4 pb-3 relative h-full min-h-0">
      ...
      <div className="flex flex-wrap items-center justify-center gap-2 px-3 py-3 rounded-xl border shrink-0"
      ...
      <div className="relative flex flex-col items-center justify-center gap-2 w-full flex-1 min-h-0 py-3 px-4 rounded-xl"
        ...
        {showPinyin && (
          <div className="px-3 py-1 rounded-lg text-sm font-semibold tracking-wide"
               style={{ backgroundColor: 'var(--accent-light)', color: 'var(--accent)' }}>
            {currentChar.pinyinChar.pinyinWithTone}
          </div>
        )}
        <div className="font-bold transition-all duration-300"
             style={{ fontSize: `${fontSize * 2}px`, color: currentChar.status === 'wrong' ? 'var(--error)' : 'var(--text-primary)' }}>
